        ...
        <div class="row">
            <div class="col-md-4">
                <article class="blog-post">
                    <h5 class="mb-2">Titre de l'article 1</h5>
                    <p>Résumé ou introduction de l'article de blog. Cliquez pour lire la suite...</p>
            ...
            <div class="col-md-4">
                <article class="blog-post">
                    <h5 class="mb-2">Titre de l'article 2</h5>
...
{{--
            <div class="col-md-4">
                <article class="blog-post">
                    ...
                    <p>Conseils, inspirations et nouveautés à découvrir ici...</p>
                    <a href="#" class="btn btn-outline-primary btn-sm">Lire plus</a>
                </article>
            </div>
        </div>
