...
<section class="single-post-section py-5">
    <div class="container">
        ...
        <img src="{{ asset('ultras/images/blog-single.jpg') }}" class="img-fluid my-4" alt="Article">

        <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac purus a arcu ullamcorper porttitor. Integer luctus euismod augue.
        </p>

        <p>
            Phasellus euismod nisl at felis sollicitudin, nec tincidunt erat faucibus. Morbi porttitor est sit amet turpis volutpat, in eleifend arcu blandit.
        </p>

        <a href="{{ url('/blog') }}" class="btn btn-secondary mt-4">← Retour au blog</a>
    </div>
</section>
