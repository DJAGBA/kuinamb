...
{{-- <section class="styles-section py-5">
    <div class="container">
        ...
        <p class="text-center">Retrouvez nos différentes collections : streetwear, casual, business et bien plus encore.</p>

        <div class="row mt-5">
            <div class="col-md-4 text-center">
                <h5>Streetwear</h5>
                <img src="{{ asset('ultras/images/style1.jpg') }}" class="img-fluid mb-3" alt="Streetwear">
            </div>
            <div class="col-md-4 text-center">
                <h5>Classique</h5>
                <img src="{{ asset('ultras/images/style2.jpg') }}" class="img-fluid mb-3" alt="Classique">
            </div>
            <div class="col-md-4 text-center">
                <h5>Chic</h5>
                <img src="{{ asset('ultras/images/style3.jpg') }}" class="img-fluid mb-3" alt="Chic">
            </div>
        </div>
    </div>
</section>
