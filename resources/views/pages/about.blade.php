...
@section('title', 'À propos - Ultras')

@section('content')

<!-- Début de la page À propos -->
<section class="about-section py-5">
    <div class="container">
        <h2 class="text-center mb-4">À propos de nous</h2>
        <p class="text-center">
            Ultras est une boutique de vêtements tendance qui met en avant l’élégance, la qualité et la satisfaction de ses clients.
        </p>
    </div>
</section>
